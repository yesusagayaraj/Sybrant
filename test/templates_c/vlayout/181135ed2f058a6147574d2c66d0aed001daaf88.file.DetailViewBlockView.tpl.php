<?php /* Smarty version Smarty-3.1.7, created on 2016-12-19 11:01:18
         compiled from "/home/sybrantdigital/public_html/cf/includes/runtime/../../layouts/vlayout/modules/Vtiger/DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:118761235057da4187b08cb9-25881616%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '181135ed2f058a6147574d2c66d0aed001daaf88' => 
    array (
      0 => '/home/sybrantdigital/public_html/cf/includes/runtime/../../layouts/vlayout/modules/Vtiger/DetailViewBlockView.tpl',
      1 => 1482145215,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '118761235057da4187b08cb9-25881616',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_57da4187c419d',
  'variables' => 
  array (
    'RECORD_STRUCTURE' => 0,
    'BLOCK_LABEL_KEY' => 0,
...
<?php if ($_valid && !is_callable('content_57da4187c419d')) {function content_57da4187c419d($_smarty_tpl) {?>
...
" <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=='19'||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=='20'){?> colspan="3" <?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['COUNTER']->value+1, null, 0);?> <?php }?>><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=='59';?>
<?php $_tmp8=ob_get_clean();?><?php if ($_tmp8){?><span class = "value"><?php echo $_smarty_tpl->tpl_vars['PROJECT_NAME']->value;?>
</span><?php }else{ ?><span class="value" data-field-type="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType();?>
