<?php /* Smarty version Smarty-3.1.7, created on 2016-12-19 11:48:59
         compiled from "/home/sybrantdigital/public_html/cf/includes/runtime/../../layouts/vlayout/modules/Vtiger/uitypes/Reference.tpl" */ ?>
<?php /*%%SmartyHeaderCode:168948978257da411e3af686-53971959%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f16f5cc507476a013afc86592814816ee89616b5' => 
    array (
      0 => '/home/sybrantdigital/public_html/cf/includes/runtime/../../layouts/vlayout/modules/Vtiger/uitypes/Reference.tpl',
      1 => 1482148135,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '168948978257da411e3af686-53971959',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_57da411e44666',
  'variables' => 
  array (
    'FIELD_MODEL' => 0,
    'REFERENCE_LIST' => 0,
...
<?php if ($_valid && !is_callable('content_57da411e44666')) {function content_57da411e44666($_smarty_tpl) {?>
...
" /><?php }?><?php }?><!--Project DetailsDate :14-12-2016--><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName()=='product_id'&&$_smarty_tpl->tpl_vars['MODULE']->value=='HelpDesk'){?><input id="sourceRecord" type="hidden" name="sourceRecord" value="<?php echo $_smarty_tpl->tpl_vars['SOURCE_RECORD']->value;?>
" /><input id="record" type="hidden" name="record" value="<?php echo $_smarty_tpl->tpl_vars['RECORD_ID']->value;?>
" /><select class="chzn-select <?php if ($_smarty_tpl->tpl_vars['OCCUPY_COMPLETE_WIDTH']->value){?> row-fluid <?php }?>" id="project_id" name="project_id" data-validation-engine="validate[<?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory()==true){?> required,<?php }?>funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" data-fieldinfo='<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['FIELD_INFO']->value, ENT_QUOTES, 'UTF-8', true);?>
' <?php if (!empty($_smarty_tpl->tpl_vars['SPECIAL_VALIDATOR']->value)){?>data-validator='<?php echo Zend_Json::encode($_smarty_tpl->tpl_vars['SPECIAL_VALIDATOR']->value);?>
'<?php }?> data-selected-value=''><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isEmptyPicklistOptionAllowed()){?><option value=""><?php echo vtranslate('LBL_SELECT_OPTION','Vtiger');?>
</option><?php }?><?php  $_smarty_tpl->tpl_vars['PROJECT_NAME'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['PROJECT_NAME']->_loop = false;
 $_smarty_tpl->tpl_vars['PROJECT_ID'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['PROJECT_DETAILS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['PROJECT_NAME']->key => $_smarty_tpl->tpl_vars['PROJECT_NAME']->value){
$_smarty_tpl->tpl_vars['PROJECT_NAME']->_loop = true;
 $_smarty_tpl->tpl_vars['PROJECT_ID']->value = $_smarty_tpl->tpl_vars['PROJECT_NAME']->key;
?><option value="<?php echo $_smarty_tpl->tpl_vars['PROJECT_ID']->value;?>
" data-picklistvalue= '<?php echo $_smarty_tpl->tpl_vars['PROJECT_NAME']->value;?>
' <?php if ($_smarty_tpl->tpl_vars['PROJECTID']->value==$_smarty_tpl->tpl_vars['PROJECT_ID']->value){?> selected <?php }?><?php if (array_key_exists($_smarty_tpl->tpl_vars['PROJECTID']->value,$_smarty_tpl->tpl_vars['PROJECT_DETAILS']->value)){?> data-recordaccess=true <?php }else{ ?> data-recordaccess=false <?php }?>data-userId="<?php echo $_smarty_tpl->tpl_vars['PROJECTID']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['PROJECT_NAME']->value;?>
</option><?php } ?></select><?php }else{ ?><input name="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName();?>
...
$(document).ready(function(){
   ...
   $('#project_id option').each(function(){
    		if( $(this).val() == sourceRecord){
    			
    			
                //$('#project_id').val(3).prop('selected', true);
               // $('#project_id option:eq(3)')
