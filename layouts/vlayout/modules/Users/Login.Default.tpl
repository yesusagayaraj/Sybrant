...
<html>
	...
	<body>
		<div class="container-fluid login-container">
			<div class="row-fluid">
				<div class="span3">
					<div class="logo"><img src="layouts/vlayout/skins/images/headerlogo_2.png">
					<br />
					...
					<div class="content-wrapper">
						<div class="container-fluid">
							<div class="row-fluid">
								...
								<div class="span6" id="login-align">
									<div class="login-area">
										<div class="login-box" id="loginDiv">
											<div class="">
												<h3 class="login-header">Login to Sybrant</h3>
		</div>
			...
			<div class="control-group">
				...
				<div class="controls">
											...
											<div class="login-subscript">
												<small> Powered by Sybrant </small>
												<!--<small> Powered by Sybrant {$CURRENT_VERSION}</small>-->
											</div>
				</div>
						...
						<div class="span6 pull-left" >
							<div class="footer-content">
								<small>&#169 2004-{date('Y')}&nbsp;
									<a href="https://www.sybrant.com">Sybrant</a> 
