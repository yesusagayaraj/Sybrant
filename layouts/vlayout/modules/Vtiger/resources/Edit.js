...
jQuery.Class("Vtiger_Edit_Js",{
	...
	registercalculations : function(container) {
	//alert("The text has been changed.");
	$('#Potentials_editView_fieldName_probability').blur(function() {
	//alert("The text has been changed."); 
	
	});
	    
	
	$('select[name="sales_stage"]').change(function(){ 
	var sales_stage = $(this).val();
	if(sales_stage == "Needs Analysis") { 
	$('#Potentials_editView_fieldName_probability').val('30');
	var percent = $('#Potentials_editView_fieldName_probability').val();
	var amount = $('#Potentials_editView_fieldName_amount').val();
	var total_amount = amount *percent/100;
	$('#Potentials_editView_fieldName_forecast_amount').val(total_amount);
	}
	if(sales_stage == "Proposal or Price Quote") {
	$('#Potentials_editView_fieldName_probability').val('50');
	var percent = $('#Potentials_editView_fieldName_probability').val();
	var amount = $('#Potentials_editView_fieldName_amount').val();
	var total_amount = amount *percent/100;
	$('#Potentials_editView_fieldName_forecast_amount').val(total_amount);
	}
	if(sales_stage == "Presentation") {
	$('#Potentials_editView_fieldName_probability').val('60');
	var percent = $('#Potentials_editView_fieldName_probability').val();
	var amount = $('#Potentials_editView_fieldName_amount').val();
	var total_amount = amount *percent/100;
	$('#Potentials_editView_fieldName_forecast_amount').val(total_amount);
	}
	if(sales_stage == "Negotiation or Review") {
	$('#Potentials_editView_fieldName_probability').val('70');
	var percent = $('#Potentials_editView_fieldName_probability').val();
	var amount = $('#Potentials_editView_fieldName_amount').val();
	var total_amount = amount *percent/100;
	$('#Potentials_editView_fieldName_forecast_amount').val(total_amount);
	...
	$('#Potentials_editView_fieldName_probability').val('100');
	var percent = $('#Potentials_editView_fieldName_probability').val();
	var amount = $('#Potentials_editView_fieldName_amount').val();
	var total_amount = amount *percent/100;
	$('#Potentials_editView_fieldName_forecast_amount').val(total_amount);
	...
	$('#Potentials_editView_fieldName_probability').val('0');
	var percent = $('#Potentials_editView_fieldName_probability').val();
	var amount = $('#Potentials_editView_fieldName_amount').val();
	var total_amount = amount *percent/100;
	$('#Potentials_editView_fieldName_forecast_amount').val(total_amount);
	}
	if(sales_stage == "Deferred") {
	$('#Potentials_editView_fieldName_probability').val('0');
	var percent = $('#Potentials_editView_fieldName_probability').val();
	var amount = $('#Potentials_editView_fieldName_amount').val();
	var total_amount = amount *percent/100;
...
//var country_id = $('select[name="sales_stage"] option:selected').val();
	/**
	...
	registerBasicEvents : function(container) {
		...
		this.registercalculations(container);
	 ...
	 */
	// registerSubmitCalculation: function() {
   ...
   // }
	...
	registerEvents: function(){
		...
		//this.registerSubmitCalculation();
