...
class PDFMaker_imagesSelect_View extends Vtiger_BasicAjax_View {
    ...
    public function process(Vtiger_Request $request) {
        ...
        foreach ($products as $productnameid => $data) {
            ...
            $imgHTML.='<img src="'.$denied_img.'" width="30" align="absmiddle" title="' . vtranslate('LBL_NO_IMAGE','PDFMaker') . '" alt="' . vtranslate('LBL_NO_IMAGE','PDFMaker'). '"/></td>';
		...
		<div class="modal-header">
			...
			<h3>' . vtranslate('LBL_PRODUCT_IMAGE','PDFMaker') . '</h3>
		</div>
