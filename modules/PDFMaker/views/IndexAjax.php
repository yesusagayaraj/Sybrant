        ...
        echo '<div xmlns="http://www.w3.org/1999/xhtml" style="min-width: 350px;" class="modelContainer" id="PDFMakerProductsImageContainer">
            ...
            <table border=0 cellspacing=0 cellpadding=5 width=100% align=center>
                <tr><td class="small">
                    <table border=0 cellspacing=0 cellpadding=5 width=100% align=center bgcolor=white>
                        <tr>
                          <td class="detailedViewHeader" style="padding-top:5px;padding-bottom:5px;"><img src="layouts/vlayout/modules/PDFMaker/images/bl.png" border="0" align="absmiddle" title="' . vtranslate("LBL_BREAKLINE_DESC","PDFMaker") . '"/></td>
