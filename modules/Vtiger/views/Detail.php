...
//Date :14-12-2016
        if($moduleName == 'HelpDesk') {
        	...
        	$projectSql = "SELECT vp.projectname FROM  vtiger_troubletickets AS vtic INNER JOIN vtiger_project AS vp ON vtic.product_id =vp.projectid WHERE vtic.ticketid=?";
	        $resultProject = $adb->pquery($projectSql, array($recordId));
